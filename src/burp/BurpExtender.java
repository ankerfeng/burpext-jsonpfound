...
public class BurpExtender extends AbstractTableModel implements IBurpExtender, ITab, IHttpListener, IMessageEditorController
{
    ...
    public void registerExtenderCallbacks(final IBurpExtenderCallbacks callbacks)
    {
        ...
        callbacks.setExtensionName("JsonpTool");
    ...
    public void processHttpMessage(int toolFlag, boolean messageIsRequest, IHttpRequestResponse messageInfo)
    {
        ...
        if (!messageIsRequest)
        {
            ...
            String resp = new String(helpers.bytesToString(messageInfo.getResponse()));
			
			String line = resp.substring(responseInfo.getBodyOffset());
